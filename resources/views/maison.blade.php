@include('layout.navbar')
    ...
    <main>
        ...
        <section class="bd-breadcrumb-area p-relative fix">
            ...
            <div class="bd-breadcrumb-bg" data-background="assets/images/bg/maison.jpg"></div>
                        ...
                        <div class="col-xl-10">
                            <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                                <div class="bd-breadcrumb-content text-center">
                                    <h1 class="bd-breadcrumb-title">MAISON D’ABEILLE</h1>
                        ...
                        <div class="destinations-details-wrapper">
                            <div class="destinations-details mb-25">
                                <div class="destinations-details-slider details-slide p-relative mb-30">
                                    <div class="swiper details-slide-activation">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <img src="assets/images/bg/maison2.jpg" alt="image">
                                            </div>
                                ...
                                <div class="destinations-details-content">
                                    <h3 class="destinations-details-title mb-15">MAISON D’ABEILLE (DAR NAHLA)
                                ...
                                <div style="margin-top: 10px;" class="post-details-blockquote mb-30">
                                    <blockquote>
                                        <h4 class="blockquote-title">Les mots sont comme les abeilles : ils ont le miel
                                            et l'aiguillon.</h4>
                                        <p class="d-flex justify-content-end"><span>De Proverbe suisse</span></p>
                                    </blockquote>
                                </div>
                                        ...
                                        @foreach ($maison->images as $image)
                                            <div class="col-md-4">
                                                ...
                                                style="height: 250px;"
                                                    ...
                                                    <img  id="ty" src="{{ asset("storage/$image") }}" alt="image">
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
