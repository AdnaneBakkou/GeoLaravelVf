                        ...
                        <div class="col-xl-10">
                            <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                                <div class="bd-breadcrumb-content text-center">
                                    <h1 class="bd-breadcrumb-title">Ville Chefchaouen</h1>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-10">
                        <div class="destinations-details-wrapper">
                            <div class="destinations-details mb-25">
                                <div style="text-align: justify;" class="destinations-details-content">
                                    {!! $chefchaouen->description !!}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row gy-24 justify-content-center">
                    <div class="col-xxl-12 col-xl-12 col-lg-12">
                        ...
                        <div class="row gy-24">
                            @foreach ($chefchaouen->images as $image)
