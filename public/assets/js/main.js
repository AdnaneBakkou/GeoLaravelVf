...
function title_animation() {
    ...
    quotes.forEach(quote => {
        ...
        // Adjust GSAP settings to target lines
        if (animation[1] == "style-1") {
            gsap.set(quote.split.lines, {
                opacity: 0,
                y: "90%",
                rotateX: "-40deg"
            });
        ...
        // Animate lines instead of chars
        quote.animation = gsap.to(quote.split.lines, {
            scrollTrigger: {
                trigger: quote,
                start: "top 90%",
            },
            ...
            duration: 1,
            ease: Back.easeOut,
            stagger: 0.2, // Adjust stagger for lines
        });
    });
}
